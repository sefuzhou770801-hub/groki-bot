...
export const Var = Object.freeze({
  ...
  // The aora eye-ring coordinate range starts at 0x25 and is generated by the loop below:
  // ring_l0x, ring_l0y, ..., ring_l47y, ring_r0x, ..., ring_r47y。
  // The C++ side provides them through DrawContext::aora_ring (Var::RingBase / kRingVarCount in
  // components/avatar_vm/opcodes.hpp match this).
  ...(() => {
    const out = {};
    let id = 0x25;
