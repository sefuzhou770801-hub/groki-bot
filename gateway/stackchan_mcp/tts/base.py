...
PCMStream = bytes | AsyncIterator[bytes]
...
class TTSEngine(ABC):
    ...
    @abstractmethod
    async def synthesize(self, text: str, **opts: Any) -> PCMStream:
        ...
        Returns:
            Raw PCM bytes, or an async iterator yielding raw PCM bytes,
            at 16 kHz, mono, signed 16-bit little-endian. The orchestrator
            handles Opus encoding and frame chunking before pushing to
            the device.
        """
