...
Environment variables:
  ...
  GEMINI_API_KEY    Google AI Studio key for Gemini Live voice conversation.

See README.md for full setup, including the robot's XiaoZhi server URL
(ws://<this computer's LAN IP>:8765) and the optional wake word model.
"""
